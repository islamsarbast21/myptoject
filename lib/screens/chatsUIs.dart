        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
                border: Border(
                    top: BorderSide(
                        color: Color.fromARGB(255, 34, 118, 111), width: 5))),
            child: Container(
              decoration:
                  BoxDecoration(color: Color.fromARGB(255, 34, 118, 111)),
              child: Row(
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 18, 82, 110)),
                    width: 290,
                    child: Expanded(
                        child: TextField(
    ...
    return Column(
      ...
      children: [
        Text(
          '$sender',
          style: TextStyle(
              fontSize: 12, color: Color.fromARGB(255, 219, 207, 172)),
        ),
        Padding(
